...
The existence of ***tables, tab panels and callouts*** in Quarto was only discovered through my research. These features helped to make my website much more readable and easy to navigate, whilst providing elements of interactivity. I was also able to style my website ***using Inspect to identify the element's class and make changes in my styles.css sheet accordingly***, the most significant being making the outline of the tab panels red to stand out more.
